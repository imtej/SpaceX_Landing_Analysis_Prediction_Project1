...
spacex_df = pd.read_csv(r"D:\IBM DS\Applied Data Science Capstone project\Week 3\spacex_launch_dash.csv")
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        fig = px.pie(success_counts, values='Successful Launches', names='Launch Site',  ## Purpose to show the No of Successful launches per site
                     title='Site with Largest Successful Launches')
    else:
